...
import imp
#lumapi = imp.load_source("lumapi", "C:\\Program Files\\Lumerical\\FDTD\\api\\python\\lumapi.py") # Windows
lumapi = imp.load_source("lumapi", "/opt/lumerical/2019b/api/python/lumapi.py")  # Linux
#lumapi = imp.load_source("lumapi.py", "/Applications/Lumerical/FDTD Solutions/FDTD Solutions.app/Contents/API/Python/lumapi.py") # Mac
